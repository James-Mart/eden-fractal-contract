...
namespace eden_fractal {
    namespace errors {
        ...
        constexpr std::string_view circleInvalidAdminAcc = "Circle account is already in or invited to a circle.";
        ...
        constexpr std::string_view circleMaxSize = "Members + Open Invites must not exceed 12.";  // Message change needed if circle settings change
        constexpr std::string_view circleInviteDNE = "Circle invite does not exist.";
        constexpr std::string_view circleInviteeDNE = "Cirlce invitee does not exist.";
        constexpr std::string_view circleDelWithMembers = "Circle cannot be deleted if it still has members.";
        constexpr std::string_view circleDelWithInvites = "Circle cannot be deleted if it still has open invites.";
        constexpr std::string_view circleNotAMember = "Only a member of that circle can perform that action.";
        constexpr std::string_view circleCannotInviteMember = "Invitee already on circle";
        constexpr std::string_view circleAlreadyInCircle = "You cannot join more than one circle.";
        constexpr std::string_view circleAlreadyInvited = "Invitee is already invited.";
        constexpr std::string_view circle20DaysJoinDelay = "You must wait a total of 20 days before joining another team.";  // Message change needed if circle settings change
        constexpr std::string_view circleNoAdminAccRank = "No circle admin account is allowed to be ranked in consensus rounds. Only circle members.";
